...
class InMemoryCacheBackend:
    ...
    def __init__(self):
        self._storage: dict[str, tuple[bytes, int | None]] = {}
...
class MockLLMRouter:
    ...
    def __init__(
        self,
        providers: dict[str, MockLLMClient] | None = None,
        ...
        self._cost_tracker: dict[str, float] = dict.fromkeys(self._providers, 0.0)
    ...
    def get_provider(self, name: str) -> MockLLMClient | None:
...
class MockMessagePublisher:
    ...
    def __init__(self, connection: MockMessageConnection | None = None):
...
class MockHTTPClient:
    ...
    def __init__(self, responses: dict[str, MockHTTPResponse] | None = None):
...
class TestDependencyFactory:
    ...
    def create_http_client(
        responses: dict[str, MockHTTPResponse] | None = None,
    ) -> MockHTTPClient:
