...
from src.shared.utils.logging.context import _service_name_var
from src.shared.utils.logging.formatters import StructuredJSONFormatter
from src.shared.utils.logging.handlers import NullHandler, SamplingHandler

_logger = logging.getLogger(__name__)


# Global configuration
_service_name_global: str | None = None
_sampling_config_global: dict | None = None
...
def configure_logging(
    ...
    if _sampling_config_global:
        sampling_handler = SamplingHandler(
            ...
            debug_rate=_sampling_config_global.get("debug", 0.01),
            info_rate=_sampling_config_global.get("info", 0.10),
            warning_rate=_sampling_config_global.get("warning", 0.50),
        )
...
def get_sampling_config() -> dict | None:
